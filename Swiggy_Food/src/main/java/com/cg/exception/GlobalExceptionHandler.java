...
public class GlobalExceptionHandler {
	...
	@Value(value = "${data.exception.foodExists}")
	...
	@ExceptionHandler(value = FoodAlreadyExistException.class)
	public ResponseEntity<String>FoodAlreadyExistException(FoodAlreadyExistException fa) {
